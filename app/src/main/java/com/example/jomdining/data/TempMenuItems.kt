...
//        Menu(1, "TEST-Chicken Chop", 25.0, "main_course", "chicken_chop"),
//        Menu(2, "TEST-Sirloin Steak", 50.75, "MainCourse", "sirloin_steak"),
//        Menu(3, "TEST-Fish and Chips", 26.0, "MainCourse", "fish_and_chips"),
//        Menu(4, "TEST-Chicken Nuggets", 11.35, "SideDish", "chicken_nuggets"),
//        Menu(5, "TEST-French Fries", 7.7, "SideDish", "french_fries"),
//        Menu(6, "TEST-Onion Rings", 9.95, "SideDish", "onion_rings"),
//        Menu(7, "TEST-A&W(L)", 6.13, "Beverage", "a_and_w"),
//        Menu(8, "TEST-Coca-Cola(L)", 6.13, "Beverage", "coca_cola"),
//        Menu(9, "TEST-Sprite(L)", 6.13, "Beverage", "sprite"),
//        Menu(10, "TEST-Sprite(L)-2", 6.13, "Beverage", "sprite"),
//        Menu(11, "TEST-Sprite(L)-3", 6.13, "Beverage", "sprite"),
//        Menu(12, "TEST-Sprite(L)-4", 6.13, "Beverage", "sprite"),
//        Menu(13, "TEST-Sprite(L)-5", 6.13, "Beverage", "sprite")
